...
final parametersBuilderMap =
  ...
  'car_crash_form': ParameterData.none(),
  'profile_page': ParameterData.none(),
  'login': ParameterData.none(),
  'reset_password': ParameterData.none(),
  'reset_password_verification': (data) async => ParameterData(
        allParams: {
  ...
  'schedule_maintenance': ParameterData.none(),
  'maintenance_scheduling': ParameterData.none(),
};
