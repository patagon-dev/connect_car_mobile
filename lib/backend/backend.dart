...
Future<int> querySuscripcionesServicesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      SuscripcionesServicesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SuscripcionesServicesRecord>> querySuscripcionesServicesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      SuscripcionesServicesRecord.collection,
      SuscripcionesServicesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SuscripcionesServicesRecord>> querySuscripcionesServicesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
