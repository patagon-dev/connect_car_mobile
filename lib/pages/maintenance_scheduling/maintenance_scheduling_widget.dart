...
class MaintenanceSchedulingWidget extends StatefulWidget {
  const MaintenanceSchedulingWidget({Key? key}) : super(key: key);
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 10.0),
                                                  child: Text(
                                                    'La hora de retiro del auto para llevarlo a la mantención es entre 8:30 y 12:00 hrs.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
