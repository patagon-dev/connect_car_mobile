    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.profileResponse?.succeeded ?? true)) {
        ...
        if (functions.resetToken(UserInfoCall.error(
          ...
          logFirebaseEvent('suscripciones_backend_call');
          _model.profileResponse1 = await UserInfoCall.call(
            token: FFAppState().userSessionToken,
            userId: FFAppState().userSessionUserId,
          );
          if ((_model.profileResponse1?.succeeded ?? true)) {
            logFirebaseEvent('suscripciones_update_page_state');
            setState(() {
              _model.profileJson = UserInfoCall.data(
                (_model.profileResponse1?.jsonBody ?? ''),
              );
            });
          }
        }
                            ...
                            children: List.generate(vehicleListData.length,
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: wrapWithModel(
                                    model: _model.carDescriptionModels.getModel(
                                    ...
                                    child: CarDescriptionWidget(
                                      ...
                                      brand: getJsonField(
                                        _model
                                            .vehicleList[vehicleListDataIndex],
                                        r'''$.brand''',
                                      ).toString(),
                                      model: getJsonField(
                                        _model
