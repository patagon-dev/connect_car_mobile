...
import 'emergencias_dialog_model.dart';
...
class EmergenciasDialogWidget extends StatefulWidget {
  ...
  _EmergenciasDialogWidgetState createState() =>
      _EmergenciasDialogWidgetState();
}

class _EmergenciasDialogWidgetState extends State<EmergenciasDialogWidget> {
  late EmergenciasDialogModel _model;
                ...
                Row(
                  ...
                  children: [
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'EMERGENCIAS_DIALOG_COMP_close_ICN_ON_TAP');
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Te contactaremos con un ejecutivo de Connect Car',
                        textAlign: TextAlign.center,
                        style:
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'EMERGENCIAS_DIALOG_Row_3yg18yfl_ON_TAP');
                          logFirebaseEvent('Row_launch_u_r_l');
                          await launchURL('tel:9016714574');
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'EMERGENCIAS_DIALOG_Row_26ub41d8_ON_TAP');
                          logFirebaseEvent('Row_launch_u_r_l');
                          await launchURL('tel:9016714574');
                        },
                        child: Row(
                    ...
                    Text(
                      '*Haz clic en caso de emergencia',
