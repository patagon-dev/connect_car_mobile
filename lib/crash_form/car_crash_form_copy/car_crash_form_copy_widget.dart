...
class CarCrashFormCopyWidget extends StatefulWidget {
  const CarCrashFormCopyWidget({super.key});

  @override
  _CarCrashFormCopyWidgetState createState() => _CarCrashFormCopyWidgetState();
}

class _CarCrashFormCopyWidgetState extends State<CarCrashFormCopyWidget> {
  late CarCrashFormCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarCrashFormCopyModel());
